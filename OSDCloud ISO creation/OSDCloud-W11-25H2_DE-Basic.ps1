...
.NOTES
    ...
    Changelog:
    - 2026-03-06: 1.0 Initial version
    
#>


# Set Workspace Folder
$ProjectName = "W11-25H2_DE-Basic"
...
Edit-OSDCloudWinPE -StartOSDCloud '-ZTI -Restart -OSName ''Windows 11 25H2 x64'' -OSEdition Enterprise -OSLanguage de-de -OSLicense Volume'
