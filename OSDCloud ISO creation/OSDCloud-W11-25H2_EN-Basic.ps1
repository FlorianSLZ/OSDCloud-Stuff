...
.NOTES
    ...
    Changelog:
    - 2025-10-01: 1.0 Initial version
    
#>


# Set Workspace Folder
$ProjectName = "W11-25H2_EN-Basic"
...
Edit-OSDCloudWinPE -StartOSDCloud '-ZTI -Restart -OSName ''Windows 11 25H2 x64'' -OSEdition Enterprise -OSLanguage en-us -OSLicense Volume'
